...
class Trainer(object):
    def __init__(self, args, model=None,train_loader=None, val_loader=None,weighted_train_loader=None,per_class_num=[],log=None, id_weights_path=None):
        self.args = args
        ...
        self.log = log
        self.beta = args.beta
        self.id_weights_path = id_weights_path
        self.update_weight()

    def update_weight(self):
        if self.id_weights_path:
            print('Using ID weights, loading from path:', self.id_weights_path)
            id_weights = np.load(self.id_weights_path)
            id_weights = id_weights ** self.label_weighting
            print('ID weights:', id_weights)
            self.per_cls_weights = torch.FloatTensor(id_weights).cuda()
        else:
            print('Not using ID weights')
