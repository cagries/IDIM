...
_C.DATASET.DATASET = "IMBALANCECIFAR10"
...
_C.DATASET.IMBALANCEPLACES = CN()
_C.DATASET.IMBALANCEPLACES.RATIO = 0.1
_C.DATASET.IMBALANCEPLACES.RANDOM_SEED = 0
...
_C.LOSS.CrossEntropy.WEIGHTS = None
...
_C.LOSS.CBID = CN()
_C.LOSS.CBID.FACTOR = 0.5
_C.LOSS.CBID.BETA = 0.999
_C.LOSS.CBID.WEIGHTS = [1.0 for i in range(10)]
...
_C.LOSS.IdFocal = CN()
_C.LOSS.IdFocal.UNC_WEIGHTS = [1.0 for i in range(10)]
_C.LOSS.IdFocal.GAMMA = 0.5
...
_C.LOSS.CBIdFocal = CN()
_C.LOSS.CBIdFocal.UNC_WEIGHTS = [1.0 for i in range(10)]
_C.LOSS.CBIdFocal.GAMMA = 0.5
_C.LOSS.CBIdFocal.BETA = 0.999
_C.LOSS.CBIdFocal.FACTOR = 1.
...
_C.TRAIN.SAMPLER.WEIGHTED_SAMPLER.TYPE = "custom"

_C.TRAIN.SAMPLER.WEIGHTED_SAMPLER.CUSTOM = CN()
_C.TRAIN.SAMPLER.WEIGHTED_SAMPLER.CUSTOM.WEIGHTS = [1. for i in range(10)]


_C.TRAIN.SAMPLER.WEIGHTED_SAMPLER.IdBased = CN()
_C.TRAIN.SAMPLER.WEIGHTED_SAMPLER.IdBased.PROBS = [1. for i in range(10)]
_C.TRAIN.SAMPLER.WEIGHTED_SAMPLER.IdBased.PROGRESSIVE = False
...
_C.TRAIN.OPTIMIZER.FEAT_LR = 0.001
