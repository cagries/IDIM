...
class BaseSet(Dataset):
    def __init__(self, mode="train", cfg=None, transform=None):
        ...
        print(self.mode, self.json_path)
        ...
        print("Number of samples in classes:\n", num_list)
    ...
    def update(self, epoch):
        ...
        if self.cfg.TRAIN.SAMPLER.WEIGHTED_SAMPLER.TYPE == "id-based" and self.cfg.TRAIN.SAMPLER.WEIGHTED_SAMPLER.IdBased.PROGRESSIVE:
            self.progress_p = epoch/self.cfg.TRAIN.MAX_EPOCH * self.id_p + (1-epoch/self.cfg.TRAIN.MAX_EPOCH)*self.instance_p
            print('self.progress_p (id-based):', self.progress_p)
    ...
    def update_transform(self, input_size=None):
        if self.cfg.BACKBONE.TYPE == 'swin':
