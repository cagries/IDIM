...
parser.add_argument('--id_sampling_weight_path', default=None, type=str, help='Path to ID weights .npy file')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # Kinda have to hard-code this for the moment
    num_classes = 1000  # TODO
    ...
    if args.id_sampling_weight_path is None:
        train_sampler = None
    else:
        print('Using ID sampling weights from:', args.id_sampling_weight_path)
        id_weights = np.load(args.id_sampling_weight_path)
        print('ID sampling weights:', id_weights)
        samples_weight = np.array([id_weights[t] for t in train_dataset.labels])
