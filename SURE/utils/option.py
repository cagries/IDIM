...
def get_args_parser():
    ...
    parser.add_argument('--id_sampling_weights_path', default=None, type=str, help='Path to ID weights .npy file')
    parser.add_argument('--id_sampling_scale', default=1.0, type=float, help='Scaling of normalized ID values')
